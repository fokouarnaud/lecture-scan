import React, { useState, useContext, Fragment, createContext, Dispatch, SetStateAction } from 'react';
...
const Content = ({ align = 'right', width = '48', contentClasses = 'py-1 bg-white dark:bg-gray-700', children }: { align?: 'left' | 'right', width?: string, contentClasses?: string, children: React.ReactNode }) => {
