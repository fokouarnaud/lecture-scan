  ...
  return (
    ...
    >
      ...
      <span
        ...
        } pointer-events-none relative inline-block h-5 w-5 transform rounded-full bg-white dark:bg-gray-200 shadow-lg ring-0 transition duration-200 ease-in-out`}
      >
        <span
          className={`${
